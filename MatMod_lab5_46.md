...
subtitle: "Модель хищник-жертва - вариант 46"
...
$$
 \begin{cases}
	\frac{dx}{dt} = -0.25x(t) + 0.05y(t)x(t)
	\\   
	\frac{dy}{dt} = 0.6y(t) - 0.061y(t)x(t)
 \end{cases}
$$
...
![График численности хищников от времени](img/1.jpg){ #fig:001 width=80% height=80% }

![График численности жертв от времени](img/2.jpg){ #fig:002 width=80% height=80% }

![График численности жертв и хищников от времени](img/3.jpg){ #fig:003 width=80% height=80% }

![График численности хищников от численности жертв](img/4.jpg){ #fig:004 width=80% height=80% }

Стационарное состояние $x_0=\frac{a}{b}=0.5, y_0=\frac{c}{d}=9.8360656$
